...
/**
 ...
 @author EMAM
 */
public class FXML_MMCController implements Initializable {
                    ...
                    if ( event.getCode() == KeyCode.ENTER ) {
                              try {
                                        if ( checkInput() ) {
                                                  ...
                                                  solve(c , arrivalRate , servesRate);
                                        } else {
                                                  throw new Exception();
                                        }
                              } catch ( Exception e ) {
          ...
          private void solve(int c , double arrivalRate , double servesRate) {
                    d = new MMCSystem(c , arrivalRate , servesRate);
